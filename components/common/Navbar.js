...
<nav className="bg-white p-2 border-gray-200 dark:bg-gray-900 dark:border-gray-700">
  <div className="max-w-screen-xxl flex flex-wrap justify-between mx-auto" style={{alignItems:"flex-start"}}>
    <a href="#" className="flex items-center nav-logo">
        <img src="/assets/images/logo.png" className="mr-3" style={{maxHeight:"144px"}} alt="Sri Sathya Sai Global Council" />
        <img src="/assets/images/logo.png" className="mr-3 setfixed" style={{maxHeight:"144px"}} alt="Sri Sathya Sai Global Council" />
        <span className="self-center text-5xl whitespace-nowrap dark:text-white display-none" style={{fontFamily:'"UnifrakturCook", cursive'}}>
          Sri Sathya Sai<br />Global Council
        </span>
    </a>
